...
async function seed() {
  ...
  console.log("Collections cleared. Seeding default Admin...");
  ...
  console.log("Seeding offers, FAQs, testimonials, spa, weddings, gallery...");
  ...
  for (const hData of hotelsData) {
    ...
    console.log(`Created 5 rooms for: ${hotel.name}`);
    ...
    console.log(`Created signature restaurant for: ${hotel.name}`);
  }
